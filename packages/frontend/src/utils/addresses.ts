...
export const getDeDeContractAddress = (
  ...
  switch (chainId) {
    ...
    case 59140: // Linea
      ...
      break;
    case 10200: // Gnosis
      contractAddress = "0xdf48692003Dd581b7E3715A26a6244f49B2e56da"; // Replace with the actual Gnosis contract address
      break;
    case 421614: // Arbitrum
      contractAddress = "0xdf48692003Dd581b7E3715A26a6244f49B2e56da"; // Replace with the actual Arbitrum contract address
      break;
    case 5: // Goerli
