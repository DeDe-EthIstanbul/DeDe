...
>(
  ...
  return watchContractEvent({ abi: ieasABI, ...config } as any, callback);
}
...
>(
  ...
  return watchContractEvent(
    { abi: iSchemaRegistryABI, ...config } as any,
    callback
  );
}
...
>(
  ...
  return watchContractEvent(
    { abi: worldIdEnabledABI, ...config } as any,
    callback
  );
}
