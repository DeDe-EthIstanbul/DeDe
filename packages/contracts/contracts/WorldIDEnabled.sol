...
contract WorldIDEnabled {
	...
	function verifyWithWorldCoin(address signal, uint256 root, uint256 nullifierHash, uint256[8] calldata proof) public {
        ...
        emit UserVerifiedWithWorldCoin(msg.sender);
